...
QECTOR Decoder v3 (v0.6.6) is a high-performance, source-available Rust and Python quantum error correction (QEC) decoding platform. Free for personal, academic, and non-commercial research. Institutional, lab, and commercial use requires a paid license.
