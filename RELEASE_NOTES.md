...
This release bundle aligns the Python package metadata, Cargo crate metadata,
runtime fallback version, and PyPI artifacts at `0.5.7`. The local Windows
CPython 3.11 wheel is `qector_decoder_v3-0.5.7-cp311-cp311-win_amd64.whl`.
